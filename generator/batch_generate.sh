...
/opt/homebrew/bin/python3 generate_collision_inline.py > ../lib/box2d_collision_inline.rb
/opt/homebrew/bin/python3 generate_id.py > ../lib/box2d_id.rb
/opt/homebrew/bin/python3 generate_id_inline.py > ../lib/box2d_id_inline.rb
