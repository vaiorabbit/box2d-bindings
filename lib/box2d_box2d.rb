...
module Box2D
  ...
  def self.setup_box2d_symbols(output_error = false)
    ...
    apis = {
      ...
      :b2Body_GetInertiaTensor => :Body_GetInertiaTensor,
      ...
      :b2Shape_GetSmoothSegment => :Shape_GetSmoothSegment,
      ...
      :b2DistanceJoint_GetHertz => :DistanceJoint_GetHertz,
      :b2DistanceJoint_GetDampingRatio => :DistanceJoint_GetDampingRatio,
    ...
    args = {
      ...
      :b2World_EnableSleeping => [WorldId.by_value, :int],
      :b2World_EnableContinuous => [WorldId.by_value, :int],
      ...
      :b2World_Explode => [WorldId.by_value, Vec2.by_value, :float, :float],
      :b2World_SetContactTuning => [WorldId.by_value, :float, :float, :float],
      :b2World_EnableWarmStarting => [WorldId.by_value, :int],
      ...
      :b2Body_ApplyForce => [BodyId.by_value, Vec2.by_value, Vec2.by_value, :int],
      :b2Body_ApplyForceToCenter => [BodyId.by_value, Vec2.by_value, :int],
      :b2Body_ApplyTorque => [BodyId.by_value, :float, :int],
      :b2Body_ApplyLinearImpulse => [BodyId.by_value, Vec2.by_value, Vec2.by_value, :int],
      :b2Body_ApplyLinearImpulseToCenter => [BodyId.by_value, Vec2.by_value, :int],
      :b2Body_ApplyAngularImpulse => [BodyId.by_value, :float, :int],
      :b2Body_GetMass => [BodyId.by_value],
      :b2Body_GetInertiaTensor => [BodyId.by_value],
      ...
      :b2Body_SetAutomaticMass => [BodyId.by_value, :int],
      ...
      :b2Body_SetAwake => [BodyId.by_value, :int],
      :b2Body_EnableSleep => [BodyId.by_value, :int],
      ...
      :b2Body_SetFixedRotation => [BodyId.by_value, :int],
      :b2Body_IsFixedRotation => [BodyId.by_value],
      :b2Body_SetBullet => [BodyId.by_value, :int],
      :b2Body_IsBullet => [BodyId.by_value],
      :b2Body_EnableHitEvents => [BodyId.by_value, :int],
      ...
      :b2Joint_SetCollideConnected => [JointId.by_value, :int],
      ...
      :b2DistanceJoint_EnableSpring => [JointId.by_value, :int],
      ...
      :b2DistanceJoint_GetHertz => [JointId.by_value],
      :b2DistanceJoint_GetDampingRatio => [JointId.by_value],
      :b2DistanceJoint_EnableLimit => [JointId.by_value, :int],
      ...
      :b2DistanceJoint_EnableMotor => [JointId.by_value, :int],
      ...
      :b2PrismaticJoint_EnableSpring => [JointId.by_value, :int],
      ...
      :b2PrismaticJoint_EnableLimit => [JointId.by_value, :int],
      ...
      :b2PrismaticJoint_EnableMotor => [JointId.by_value, :int],
      ...
      :b2RevoluteJoint_EnableSpring => [JointId.by_value, :int],
      ...
      :b2RevoluteJoint_EnableLimit => [JointId.by_value, :int],
      ...
      :b2RevoluteJoint_EnableMotor => [JointId.by_value, :int],
      ...
      :b2WheelJoint_EnableSpring => [JointId.by_value, :int],
      ...
      :b2WheelJoint_EnableLimit => [JointId.by_value, :int],
      ...
      :b2WheelJoint_EnableMotor => [JointId.by_value, :int],
    ...
    retvals = {
      :b2CreateWorld => b2WorldId,
      :b2DestroyWorld => :void,
      :b2World_IsValid => :int,
      :b2World_Step => :void,
      :b2World_Draw => :void,
      :b2World_GetBodyEvents => b2BodyEvents,
      :b2World_GetSensorEvents => b2SensorEvents,
      :b2World_GetContactEvents => b2ContactEvents,
      ...
      :b2World_CastRayClosest => b2RayResult,
      ...
      :b2Body_GetPosition => b2Vec2,
      :b2Body_GetRotation => b2Rot,
      :b2Body_GetTransform => b2Transform,
      :b2Body_SetTransform => :void,
      :b2Body_GetLocalPoint => b2Vec2,
      :b2Body_GetWorldPoint => b2Vec2,
      :b2Body_GetLocalVector => b2Vec2,
      :b2Body_GetWorldVector => b2Vec2,
      :b2Body_GetLinearVelocity => b2Vec2,
      ...
      :b2Body_GetInertiaTensor => :float,
      :b2Body_GetLocalCenterOfMass => b2Vec2,
      :b2Body_GetWorldCenterOfMass => b2Vec2,
      :b2Body_SetMassData => :void,
      :b2Body_GetMassData => b2MassData,
      :b2Body_ApplyMassFromShapes => :void,
      :b2Body_SetAutomaticMass => :void,
      :b2Body_GetAutomaticMass => :int,
      ...
      :b2Body_ComputeAABB => b2AABB,
      :b2CreateCircleShape => b2ShapeId,
      :b2CreateSegmentShape => b2ShapeId,
      :b2CreateCapsuleShape => b2ShapeId,
      :b2CreatePolygonShape => b2ShapeId,
      :b2DestroyShape => :void,
      :b2Shape_IsValid => :int,
      :b2Shape_GetType => :int,
      :b2Shape_GetBody => b2BodyId,
      :b2Shape_IsSensor => :int,
      ...
      :b2Shape_GetFilter => b2Filter,
      :b2Shape_SetFilter => :void,
      :b2Shape_EnableSensorEvents => :void,
      :b2Shape_AreSensorEventsEnabled => :int,
      :b2Shape_EnableContactEvents => :void,
      :b2Shape_AreContactEventsEnabled => :int,
      :b2Shape_EnablePreSolveEvents => :void,
      :b2Shape_ArePreSolveEventsEnabled => :int,
      :b2Shape_EnableHitEvents => :void,
      :b2Shape_AreHitEventsEnabled => :int,
      :b2Shape_TestPoint => :int,
      :b2Shape_RayCast => b2CastOutput,
      :b2Shape_GetCircle => b2Circle,
      :b2Shape_GetSegment => b2Segment,
      :b2Shape_GetSmoothSegment => b2SmoothSegment,
      :b2Shape_GetCapsule => b2Capsule,
      :b2Shape_GetPolygon => b2Polygon,
      :b2Shape_SetCircle => :void,
      :b2Shape_SetCapsule => :void,
      :b2Shape_SetSegment => :void,
      :b2Shape_SetPolygon => :void,
      :b2Shape_GetParentChain => b2ChainId,
      :b2Shape_GetContactCapacity => :int,
      :b2Shape_GetContactData => :int,
      :b2Shape_GetAABB => b2AABB,
      :b2Shape_GetClosestPoint => b2Vec2,
      :b2CreateChain => b2ChainId,
      :b2DestroyChain => :void,
      ...
      :b2DistanceJoint_IsMotorEnabled => :int,
      ...
      :b2CreateMotorJoint => b2JointId,
      :b2MotorJoint_SetLinearOffset => :void,
      :b2MotorJoint_GetLinearOffset => b2Vec2,
      ...
      :b2CreateMouseJoint => b2JointId,
      :b2MouseJoint_SetTarget => :void,
      :b2MouseJoint_GetTarget => b2Vec2,
      ...
      :b2CreatePrismaticJoint => b2JointId,
      :b2PrismaticJoint_EnableSpring => :void,
      :b2PrismaticJoint_IsSpringEnabled => :int,
      ...
      :b2PrismaticJoint_IsLimitEnabled => :int,
      ...
      :b2PrismaticJoint_IsMotorEnabled => :int,
      ...
      :b2CreateRevoluteJoint => b2JointId,
      ...
      :b2RevoluteJoint_IsLimitEnabled => :int,
      ...
      :b2RevoluteJoint_IsMotorEnabled => :int,
      ...
      :b2CreateWheelJoint => b2JointId,
      :b2WheelJoint_EnableSpring => :void,
      :b2WheelJoint_IsSpringEnabled => :int,
