...
module Box2D
  ...
  def self.setup_main_symbols(output_error = false)
    ...
    apis = {
      ...
      :b2World_OverlapPoint => :World_OverlapPoint,
      ...
      :b2World_SetMaximumLinearSpeed => :World_SetMaximumLinearSpeed,
      :b2World_GetMaximumLinearSpeed => :World_GetMaximumLinearSpeed,
      :b2World_EnableWarmStarting => :World_EnableWarmStarting,
      :b2World_IsWarmStartingEnabled => :World_IsWarmStartingEnabled,
      :b2World_GetAwakeBodyCount => :World_GetAwakeBodyCount,
      :b2World_GetProfile => :World_GetProfile,
      :b2World_GetCounters => :World_GetCounters,
      :b2World_SetUserData => :World_SetUserData,
      :b2World_GetUserData => :World_GetUserData,
      :b2World_DumpMemoryStats => :World_DumpMemoryStats,
      :b2World_RebuildStaticTree => :World_RebuildStaticTree,
      :b2World_EnableSpeculative => :World_EnableSpeculative,
      ...
      :b2Body_EnableSensorEvents => :Body_EnableSensorEvents,
      :b2Body_EnableContactEvents => :Body_EnableContactEvents,
      ...
      :b2Shape_GetSensorCapacity => :Shape_GetSensorCapacity,
      :b2Shape_GetSensorOverlaps => :Shape_GetSensorOverlaps,
      ...
      :b2Chain_GetFriction => :Chain_GetFriction,
      :b2Chain_SetRestitution => :Chain_SetRestitution,
      :b2Chain_GetRestitution => :Chain_GetRestitution,
      ...
      :b2CreateNullJoint => :CreateNullJoint,
      ...
      :b2PrismaticJoint_GetTranslation => :PrismaticJoint_GetTranslation,
      :b2PrismaticJoint_GetSpeed => :PrismaticJoint_GetSpeed,
    ...
    args = {
      ...
      :b2World_OverlapPoint => [WorldId.by_value, Vec2.by_value, Transform.by_value, QueryFilter.by_value, :pointer, :pointer],
      ...
      :b2World_SetMaximumLinearSpeed => [WorldId.by_value, :float],
      :b2World_GetMaximumLinearSpeed => [WorldId.by_value],
      :b2World_EnableWarmStarting => [WorldId.by_value, :bool],
      :b2World_IsWarmStartingEnabled => [WorldId.by_value],
      :b2World_GetAwakeBodyCount => [WorldId.by_value],
      :b2World_GetProfile => [WorldId.by_value],
      :b2World_GetCounters => [WorldId.by_value],
      :b2World_SetUserData => [WorldId.by_value, :pointer],
      :b2World_GetUserData => [WorldId.by_value],
      :b2World_DumpMemoryStats => [WorldId.by_value],
      :b2World_RebuildStaticTree => [WorldId.by_value],
      :b2World_EnableSpeculative => [WorldId.by_value, :bool],
      ...
      :b2Body_EnableSensorEvents => [BodyId.by_value, :bool],
      :b2Body_EnableContactEvents => [BodyId.by_value, :bool],
      ...
      :b2DestroyShape => [ShapeId.by_value, :bool],
      ...
      :b2Shape_SetDensity => [ShapeId.by_value, :float, :bool],
      ...
      :b2Shape_GetSensorCapacity => [ShapeId.by_value],
      :b2Shape_GetSensorOverlaps => [ShapeId.by_value, :pointer, :int],
      ...
      :b2Chain_GetFriction => [ChainId.by_value],
      :b2Chain_SetRestitution => [ChainId.by_value, :float],
      :b2Chain_GetRestitution => [ChainId.by_value],
      ...
      :b2CreateNullJoint => [WorldId.by_value, :pointer],
      ...
      :b2PrismaticJoint_GetTranslation => [JointId.by_value],
      :b2PrismaticJoint_GetSpeed => [JointId.by_value],
    ...
    retvals = {
      ...
      :b2World_OverlapAABB => TreeStats.by_value,
      :b2World_OverlapPoint => TreeStats.by_value,
      :b2World_OverlapCircle => TreeStats.by_value,
      :b2World_OverlapCapsule => TreeStats.by_value,
      :b2World_OverlapPolygon => TreeStats.by_value,
      :b2World_CastRay => TreeStats.by_value,
      :b2World_CastRayClosest => RayResult.by_value,
      :b2World_CastCircle => TreeStats.by_value,
      :b2World_CastCapsule => TreeStats.by_value,
      :b2World_CastPolygon => TreeStats.by_value,
      ...
      :b2World_SetMaximumLinearSpeed => :void,
      :b2World_GetMaximumLinearSpeed => :float,
      :b2World_EnableWarmStarting => :void,
      :b2World_IsWarmStartingEnabled => :bool,
      :b2World_GetAwakeBodyCount => :int,
      :b2World_GetProfile => Profile.by_value,
      :b2World_GetCounters => Counters.by_value,
      :b2World_SetUserData => :void,
      :b2World_GetUserData => :pointer,
      :b2World_DumpMemoryStats => :void,
      :b2World_RebuildStaticTree => :void,
      :b2World_EnableSpeculative => :void,
      ...
      :b2Body_EnableSensorEvents => :void,
      :b2Body_EnableContactEvents => :void,
      ...
      :b2Shape_GetSensorCapacity => :int,
      :b2Shape_GetSensorOverlaps => :int,
      ...
      :b2Chain_GetFriction => :float,
      :b2Chain_SetRestitution => :void,
      :b2Chain_GetRestitution => :float,
      ...
      :b2CreateNullJoint => JointId.by_value,
      ...
      :b2PrismaticJoint_GetTranslation => :float,
      :b2PrismaticJoint_GetSpeed => :float,
